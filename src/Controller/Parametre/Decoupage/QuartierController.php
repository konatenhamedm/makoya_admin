...
class QuartierController extends BaseController
{
    ...
    #[Route('/new', name: 'app_parametre_decoupage_quartier_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}/show', name: 'app_parametre_decoupage_quartier_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_parametre_decoupage_quartier_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}/delete', name: 'app_parametre_decoupage_quartier_delete', methods: ['DELETE', 'GET'])]
