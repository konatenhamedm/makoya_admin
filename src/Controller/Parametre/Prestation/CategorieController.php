...
class CategorieController extends BaseController
{
    ...
    'actions' => [
    'edit' => [
    'url' => $this->generateUrl('app_parametre_prestation_categorie_edit', ['id' => $value])
    , 'ajax' => true
    , 'icon' => '%icon% bi bi-pen'
    ...
    'show' => [
    'url' => $this->generateUrl('app_parametre_prestation_categorie_show', ['id' => $value])
    , 'ajax' => true
    , 'icon' => '%icon% bi bi-eye'
    ...
    'url' => $this->generateUrl('app_parametre_prestation_categorie_delete', ['id' => $value])
    , 'ajax' => true
