...
class CategorieController extends BaseController
{
    ...
    public function index(Request $request, DataTableFactory $dataTableFactory): Response
    {
        ...
        $table = $dataTableFactory->create()
            ...
            ->setName('dt_app_parametre_prestation_categorie');
        if ($permission != null) {
                ...
                $table->add('id', TextColumn::class, [
                    'label' => 'Actions', 'orderable' => false, 'globalSearchable' => false, 'className' => 'grid_row_actions', 'render' => function ($value, Categorie $context) use ($renders) {
                        $options = [
                            ...
                            'actions' => [
                                'edit' => [
                                    'url' => $this->generateUrl('app_parametre_prestation_categorie_edit', ['id' => $value]), 'ajax' => true, 'icon' => '%icon% bi bi-pen', 'attrs' => ['class' => 'btn-default'], 'render' => $renders['edit']
                                ],
                                'show' => [
                                    'url' => $this->generateUrl('app_parametre_prestation_categorie_show', ['id' => $value]), 'ajax' => true, 'icon' => '%icon% bi bi-eye', 'attrs' => ['class' => 'btn-primary'], 'render' => $renders['show']
                                ],
                                'delete' => [
                                    'target' => '#exampleModalSizeNormal',
                                    'url' => $this->generateUrl('app_parametre_prestation_categorie_delete', ['id' => $value]), 'ajax' => true, 'icon' => '%icon% bi bi-trash', 'attrs' => ['class' => 'btn-main'],  'render' => $renders['delete']
                                ]
                            ]
        ...
        return $this->render('parametre/prestation/categorie/index.html.twig', [
            'datatable' => $table,
    ...
    public function new(Request $request, CategorieRepository $categorieRepository, FormError $formError): Response
    {
        ...
        $form = $this->createForm(CategorieType::class, $categorie, [
            ...
            'action' => $this->generateUrl('app_parametre_prestation_categorie_new')
        ]);
        ...
        if ($form->isSubmitted()) {
            $response = [];
            $redirect = $this->generateUrl('app_parametre_prestation_categorie_index');


            if ($form->isValid()) {
                $categorie->setCode($this->numero());
        ...
        return $this->renderForm('parametre/prestation/categorie/new.html.twig', [
            'categorie' => $categorie,
            'form' => $form,
        ]);
    }
    ...
    public function edit(Request $request, Categorie $categorie, CategorieRepository $categorieRepository, FormError $formError): Response
    {
        ...
        $form = $this->createForm(CategorieType::class, $categorie, [
            ...
            'action' => $this->generateUrl('app_parametre_prestation_categorie_edit', [
                'id' =>  $categorie->getId()
            ])
        ]);
        ...
        return $this->renderForm('parametre/prestation/categorie/edit.html.twig', [
            'categorie' => $categorie,
            'form' => $form,
        ]);
    }
    ...
    public function delete(Request $request, Categorie $categorie, CategorieRepository $categorieRepository): Response
    {
        $form = $this->createFormBuilder()
            ->setAction(
                $this->generateUrl(
                    'app_parametre_prestation_categorie_delete',
                    [
                        'id' => $categorie->getId()
                    ]
                )
        ...
        return $this->renderForm('parametre/prestation/categorie/delete.html.twig', [
            'categorie' => $categorie,
            'form' => $form,
        ]);
    }
