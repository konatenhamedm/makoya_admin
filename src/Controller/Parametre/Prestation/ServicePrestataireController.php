...
class ServicePrestataireController extends BaseController
{
    ...
    , 'render' => function ($value, ServicePrestataire $context) use ($renders) {
    $options = [
    ...
    'actions' => [
    'edit' => [
    'url' => $this->generateUrl('app_parametre_prestation_service_prestataire_edit', ['id' => $value])
    , 'ajax' => true
    , 'icon' => '%icon% bi bi-pen'
    ...
    'show' => [
    'url' => $this->generateUrl('app_parametre_prestation_service_prestataire_show', ['id' => $value])
    , 'ajax' => true
    , 'icon' => '%icon% bi bi-eye'
    ...
    'url' => $this->generateUrl('app_parametre_prestation_service_prestataire_delete', ['id' => $value])
    , 'ajax' => true
